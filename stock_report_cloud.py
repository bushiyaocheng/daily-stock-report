...
def main() -> None:
    ...
    generated = dt.datetime.now(dt.timezone(dt.timedelta(hours=8))).strftime("%Y-%m-%d %H:%M HKT")
    ...
    report_path = output_dir / f"tech_stock_report_{dt.date.today().isoformat()}.md"
